...
import '@candl/v3-periphery/contracts/base/PeripheryImmutableState.sol';
import '@candl/v3-core/contracts/libraries/SafeCast.sol';
import '@candl/v3-core/contracts/libraries/TickMath.sol';
import '@candl/v3-core/contracts/libraries/TickBitmap.sol';
...
import '@candl/v3-periphery/contracts/libraries/Path.sol';
...
contract MixedRouteQuoterV1 is IMixedRouteQuoterV1, ICandlV3SwapCallback, PeripheryImmutableState {
    ...
    */
    ...
    /// @inheritdoc ICandlV3SwapCallback
    function candlV3SwapCallback(
        ...
        ICandlV3Pool pool = SmartRouterHelper.getPool(deployer, tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ICandlV3Pool pool = SmartRouterHelper.getPool(deployer, params.tokenIn, params.tokenOut, params.fee);
