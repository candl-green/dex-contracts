...
import '@candl/v3-core/contracts/libraries/LowGasSafeMath.sol';
...
library SmartRouterHelper {
    ...
    bytes32 internal constant V2_INIT_CODE_HASH = 0x6daf4e163be1365560ba4d2245da10cb9918e39f0704a70fd4353f112db41ef8;
    ...
    bytes32 internal constant V3_INIT_CODE_HASH = 0xf753a5dd29988442fd303abe8bcaf7085d629f960a19c5af88ad653283d21f72;
    ...
    /// @param deployer The CandlSwap V3 deployer contract address
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) public pure returns (ICandlV3Pool) {
        return ICandlV3Pool(computeAddress(deployer, getPoolKey(tokenA, tokenB, fee)));
    }

    /// @notice Returns the address of a valid CandlSwap V3 Pool
    /// @param deployer The contract address of the CandlSwap V3 deployer
    ...
    function verifyCallback(
        ...
        address tokenB,
        uint24 fee
    ) public view returns (ICandlV3Pool pool) {
    ...
    function verifyCallback(address deployer, PoolKey memory poolKey)
        public
        view
        returns (ICandlV3Pool pool)
    {
        pool = ICandlV3Pool(computeAddress(deployer, poolKey));
