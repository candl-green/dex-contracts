...
const CandlStableSwapFactory = artifacts.require("stable-swap/contracts/CandlStableSwapFactory.sol");
const CandlStableSwapLPFactory = artifacts.require("stable-swap/contracts/CandlStableSwapLPFactory.sol");
const CandlStableSwapTwoPoolDeployer = artifacts.require("stable-swap/contracts/CandlStableSwapTwoPoolDeployer.sol");
const CandlStableSwapThreePoolDeployer = artifacts.require("stable-swap/contracts/CandlStableSwapThreePoolDeployer.sol");
const CandlStableSwapTwoPool = artifacts.require("stable-swap/contracts/CandlStableSwapTwoPool.sol");
const CandlStableSwapThreePool = artifacts.require("stable-swap/contracts/CandlStableSwapThreePool.sol");
const CandlStableSwapTwoPoolInfo = artifacts.require("stable-swap/contracts/utils/CandlStableSwapTwoPoolInfo.sol");
const CandlStableSwapThreePoolInfo = artifacts.require("stable-swap/contracts/utils/CandlStableSwapThreePoolInfo.sol");
const CandlStableSwapInfo = artifacts.require("stable-swap/contracts/utils/CandlStableSwapInfo.sol");
const LPToken = artifacts.require("stable-swap/contracts/CandlStableSwapLP.sol");
...
const CandlFactory = artifacts.require("exchange-protocol/contracts/CandlFactory.sol");
const CandlPair = artifacts.require("exchange-protocol/contracts/CandlPair.sol");
const CandlRouter = artifacts.require("exchange-protocol/contracts/CandlRouter.sol");
...
contract("SmartRouter", ([admin, bob, carol]) => {
    ...
    before(async () => {
        ...
        /** Create Stable Swap */
        stableSwapLPFactory = await CandlStableSwapLPFactory.new({ from: admin });
        stableSwap2PoolDeployer = await CandlStableSwapTwoPoolDeployer.new({ from: admin });
        stableSwap3PoolDeployer = await CandlStableSwapThreePoolDeployer.new({ from: admin });
        stableSwapFactory = await CandlStableSwapFactory.new(stableSwapLPFactory.address, stableSwap2PoolDeployer.address, stableSwap3PoolDeployer.address, {
            from: admin,
        });
        stableSwap2PoolInfo = await CandlStableSwapTwoPoolInfo.new({ from: admin });
        stableSwap3PoolInfo = await CandlStableSwapThreePoolInfo.new({ from: admin });
        stableSwapPoolInfo = await CandlStableSwapInfo.new(stableSwap2PoolInfo.address, stableSwap3PoolInfo.address, { from: admin });
        ...
        stable2Pool_DAI_USDC = await CandlStableSwapTwoPool.at(stable2PoolInfo.swapContract);
        ...
        stable2Pool_WETH_DAI = await CandlStableSwapTwoPool.at(stable2PoolInfo_WETH_DAI.swapContract);
        ...
        stable3Pool_DAI_USDC_USDT = await CandlStableSwapThreePool.at(stable3PoolInfo.swapContract);
