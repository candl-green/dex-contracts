...
contract CandlV3PoolDeployer is ICandlV3PoolDeployer {
    struct Parameters {
        address factory;
        address token0;
        address token1;
    ...
    /// @inheritdoc ICandlV3PoolDeployer
    ...
    /// @param factory The contract address of the CandlSwap V3 factory
    ...
    function deploy(
        ...
        pool = address(new CandlV3Pool{salt: keccak256(abi.encode(token0, token1, fee))}());
        delete parameters;
    }
}
