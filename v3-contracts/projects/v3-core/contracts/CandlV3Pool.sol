...
import './interfaces/ICandlV3Factory.sol';
...
import './interfaces/ICandlV3LmPool.sol';

contract CandlV3Pool is ICandlV3Pool {
    ...
    /// @inheritdoc ICandlV3PoolImmutables
    ...
    modifier onlyFactoryOrFactoryOwner() {
        require(msg.sender == factory || msg.sender == ICandlV3Factory(factory).owner());
        _;
    }

    constructor() {
        int24 _tickSpacing;
        (factory, token0, token1, fee, _tickSpacing) = ICandlV3PoolDeployer(msg.sender).parameters();
    ...
    /// @inheritdoc ICandlV3PoolDerivedState
    ...
    /// @inheritdoc ICandlV3PoolActions
    ...
    function mint(
        ...
        ICandlV3MintCallback(msg.sender).candlV3MintCallback(amount0, amount1, data);
    ...
    function swap(
        ...
        if (zeroForOne) {
            ...
            ICandlV3SwapCallback(msg.sender).candlV3SwapCallback(amount0, amount1, data);
    ...
    function flash(
        ...
        ICandlV3FlashCallback(msg.sender).candlV3FlashCallback(fee0, fee1, data);
    ...
    /// @inheritdoc ICandlV3PoolOwnerActions
