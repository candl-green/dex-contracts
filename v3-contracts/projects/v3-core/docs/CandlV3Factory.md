...
Deploys CandlSwap V3 pools and manages ownership and control over pool protocol fees
...
```solidity
mapping(uint24 => struct ICandlV3Factory.TickSpacingExtraInfo) feeAmountTickSpacingExtraInfo
```
