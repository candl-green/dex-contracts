...
contract QuoterV2 is IQuoterV2, ICandlV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (ICandlV3Pool) {
        return ICandlV3Pool(PoolAddress.computeAddress(deployer, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }
    ...
    function candlV3SwapCallback(
        ...
        ICandlV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        ICandlV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
