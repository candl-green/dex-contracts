import { abi as ICandlV3PoolABI } from '@candl/v3-core/artifacts/contracts/interfaces/ICandlV3Pool.sol/ICandlV3Pool.json'
import { Fixture } from 'ethereum-waffle'
import { BigNumber, constants, ContractTransaction, Wallet } from 'ethers'
import { ethers, waffle } from 'hardhat'
import { ICandlV3Pool, IWETH9, MockTimeSwapRouter, TestERC20 } from '../typechain-types'
...
describe('SwapRouter gas tests', function () {
  ...
  const swapRouterFixture: Fixture<{
    ...
    pools: [ICandlV3Pool, ICandlV3Pool, ICandlV3Pool]
    ...
    const pools = poolAddresses.map((poolAddress) => new ethers.Contract(poolAddress, ICandlV3PoolABI, wallet)) as [
      ICandlV3Pool,
      ICandlV3Pool,
      ICandlV3Pool
    ]
  ...
  let pools: [ICandlV3Pool, ICandlV3Pool, ICandlV3Pool]
  ...
  describe('#exactInput', () => {
    ...
    it.skip('0 -> 1 minimal', async () => {
      const calleeFactory = await ethers.getContractFactory('TestCandlV3Callee')
