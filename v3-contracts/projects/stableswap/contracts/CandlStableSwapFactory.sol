...
import "./interfaces/ICandlStableSwap.sol";
import "./interfaces/ICandlStableSwapLP.sol";
import "./interfaces/ICandlStableSwapDeployer.sol";
import "./interfaces/ICandlStableSwapLPFactory.sol";

contract CandlStableSwapFactory is Ownable {
    ...
    ICandlStableSwapLPFactory public immutable LPFactory;
    ICandlStableSwapDeployer public immutable SwapTwoPoolDeployer;
    ICandlStableSwapDeployer public immutable SwapThreePoolDeployer;
     ...
     */
    constructor(
        ICandlStableSwapLPFactory _LPFactory,
        ICandlStableSwapDeployer _SwapTwoPoolDeployer,
        ICandlStableSwapDeployer _SwapThreePoolDeployer
    ) {
    ...
    function createSwapPair(
        ...
        ICandlStableSwapLP(LP).setMinter(swapContract);
    ...
    function addPairInfo(address _swapContract) external onlyOwner {
        ICandlStableSwap swap = ICandlStableSwap(_swapContract);
