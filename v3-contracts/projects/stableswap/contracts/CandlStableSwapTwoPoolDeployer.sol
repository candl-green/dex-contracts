...
import "./CandlStableSwapTwoPool.sol";

contract CandlStableSwapTwoPoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(CandlStableSwapTwoPool).creationCode;
        ...
        CandlStableSwapTwoPool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
