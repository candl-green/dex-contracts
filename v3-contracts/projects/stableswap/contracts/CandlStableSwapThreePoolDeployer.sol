...
import "./CandlStableSwapThreePool.sol";

contract CandlStableSwapThreePoolDeployer is Ownable {
    ...
    function createSwapPair(
        ...
        bytes memory bytecode = type(CandlStableSwapThreePool).creationCode;
        ...
        CandlStableSwapThreePool(swapContract).initialize(coins, _A, _fee, _admin_fee, _admin, _LP);
