...
import "./CandlStableSwapLP.sol";

contract CandlStableSwapLPFactory is Ownable {
    ...
    function createSwapLP(
        ...
        // create LP token
        bytes memory bytecode = type(CandlStableSwapLP).creationCode;
        ...
        CandlStableSwapLP(lpToken).setMinter(_minter);
