...
describe('CandlV3Pool', () => {
  ...
  let pool0: MockTimeCandlV3Pool
  let pool1: MockTimeCandlV3Pool
  ...
  let swapTargetCallee: TestCandlV3Callee
  let swapTargetRouter: TestCandlV3Router
  ...
  beforeEach('deploy first fixture', async () => {
    ...
    ): Promise<[MockTimeCandlV3Pool, any]> => {
