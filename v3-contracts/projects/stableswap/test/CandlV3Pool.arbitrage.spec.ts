...
import { CandlV3PoolSwapTest } from '../typechain-types/contracts/test/CandlV3PoolSwapTest'
...
describe('CandlV3Pool arbitrage tests', () => {
      ...
      for (const passiveLiquidity of [
        ...
        describe(`passive liquidity of ${formatTokenAmount(passiveLiquidity)}`, () => {
          const arbTestFixture = async ([wallet, arbitrageur]: Wallet[]) => {
            ...
            const testerFactory = await ethers.getContractFactory('CandlV3PoolSwapTest')
            const tester = (await testerFactory.deploy()) as CandlV3PoolSwapTest
          ...
          let tester: CandlV3PoolSwapTest
